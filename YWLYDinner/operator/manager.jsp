  ...
  <TABLE height="100%" cellSpacing=0 cellPadding=0 width="100%" border=0>
    <TBODY>
      <TR style="BACKGROUND-IMAGE: url(../images/bg_header.gif); BACKGROUND-REPEAT: repeat-x" height=47>
        ...
        PADDING-TOP: 10px; BACKGROUND-REPEAT: repeat-x; HEIGHT: 47px; TEXT-ALIGN: center; 0px: ">注册餐馆</SPAN>
  	...
  	<form action="../insert" name="form" method="post" enctype="multipart/form-data">
  		<table  class=gridView>
  			<tr><td align="right">登录用户名：</td><td><input type="text" name="resLoginName" ></td>
  			<td align="right">登录密码：</td><td><input type="text" name="resLoginPassword" ></td></tr>
  			<tr><td align="right">餐馆名：</td><td><input type="text" name="resName" ></td>
  			<td align="right">餐馆地址：</td><td><input type="text" name="resAdd" ></td></tr>
  			<tr><td align="right">餐馆电话：</td><td><input type="text" name="resPhone" ></td>
  			<td align="right">老板ID：</td><td><input type="text" name="resCEOIDNum" ></td></tr>
  			<tr><td align="right">老板姓名：</td><td><input type="text" name="resCEOName" ></td>
  			<td align="right">营业执照：</td><td><input type="text" name="resPermitNum" ></td></tr>
  			<tr><td align="right">老板Tel：</td><td><input type="text" name="resCEOPhone" ></td>
  			<td align="right">老板住址：</td><td><input type="text" name="resCEOAdd" ></td></tr>
  			<tr><td align="right">餐馆图片：</td><td><input type="file" name="pic"></td>  			
  			<td align="right">餐馆状态：</td><td><select name="resState">
  				<option value="1">正常</option>
  				<option value="2">欠费</option>
  			</select></td></tr>
  			<tr><td></td><td><font color="red" size="2">如果不上传，可以不选！</font></td>
  			<td align="right">餐馆所在区：</td><td><select name="resDistrict">
  			...
  			<tr><td align="right">餐馆介绍：</td><td><textarea cols="20" rows="5" name="resIntroduce"></textarea></td></tr>
  			<tr><td colspan="2"></td>
  			</tr>  			
  		</table>
  		<center><input class=cmdField type="submit" value="提交">
